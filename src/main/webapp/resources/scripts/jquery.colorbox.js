...
(function ($, window) {
	...
	publicMethod.position = function (speed, loadedCallback) {
		...
		posTop = Math.max(document.documentElement.clientHeight - settings.h - loadedHeight - interfaceHeight, 0) / 8 + $window.scrollTop(),
	...
	publicMethod.load = function (launched) {
		...
		if (settings.inline) {
			...
			$box.one(event_loaded, function () {
				var iframe = $("<iframe id='editFrame' frameborder='0' style='width:100%; height:100%; border:0; display:block'/>")[0];
